...
let targets = ['csharp_restsharp', 'go_native', 'java_okhttp', 'java_unirest', 'node_axios', 'node_fetch', 'shell_curl', 'shell_httpie', 'python_python3', 'php_curl', 'php_http1', 'php_http2'];
